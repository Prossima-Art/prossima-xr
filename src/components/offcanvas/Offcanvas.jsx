...
export function OffCanvasExample({ ...props }) {
  ...
  return (
    <>
      <Button variant="primary" className="button rounded-1 bg-info border-0" onClick={handleShow}>
        Contact Us
      </Button>
      ...
      <Offcanvas
        ...
        {...props}
      >
        <Offcanvas.Header closeButton className="gray-200">
          <Offcanvas.Title>
            <Logo
              Width="243"
              Height="21.88"
        ...
        <Offcanvas.Body>
          <h1 className="fs-3">Interested in seeing more? We'd love to have you</h1>
          ...
          <Form className="mb-5" onSubmit={addNewContacts}>
            ...
            <Button
              className="rounded-1 bg-info border-0"
              style={{
